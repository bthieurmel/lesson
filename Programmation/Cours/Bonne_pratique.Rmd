...
* C'est important d'adopter des bonnes pratiques de codage :
...
* Noms __courts__ et __explicites__, de préférence __en minuscule__, en évitant d'utiliser des noms de fonctions connues...
...
* Exception pour `:`, `::` (accès aux fonctions exportées d'un package) and `:::` (fonctions non exportées)
...
* L'ouverture d'une accolade doit __toujours__ être suivie d'un passage à la ligne. 
* La fermeture d'un accolade doit être suivie d'un passage à la ligne, sauf dans le cas d'un __else__
