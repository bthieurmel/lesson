...
* __| (||)__ : opérateur logique 'OR'. Vrai si au-moins une des deux conditions est vrai, faux sinon
```{r, eval = FALSE}
(x == 1 || y == 10)   # TRUE
(x == 1 || y == 9)    # TRUE
(x == 2 || y == 9)    # FALSE
...
* __xor__ : opérateur logique 'OR' exclusif. Vrai si une et une seule condition est vrai, faux sinon
```{r, eval = FALSE}
xor(TRUE, FALSE) # TRUE
xor(TRUE, TRUE)  # FALSE
`````
...
* Rarement efficaces...
* Donc à utliser avec précautions dans __R__
...
* Tant que la condition est vrai, on continue
    ...
    + Si elle est toujours vrai, ou si il n'y a pas de sortie __explicite__, elle continue à tourner...!
