...
* Pour voir les informations : utilisation de _print()_ dans la fonction

* Quand une erreur se produit, utilisation du __traceback__
    + Disponible par défaut dans la console RStudio
    + via la fonction _traceback()_ dans R

<div style="text-align:center" markdown="1">
<img src="images/traceback.png" alt="Drawing" style="width: 950px;"/>
</div>
