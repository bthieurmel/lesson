...
On gère le type des points avec __pch__ (_?points). __cex__ fixe la taille des p oints :
...
* __googleVis__ : https://cran.r-project.org/web/packages/googleVis/vignettes/googleVis_examples.html
