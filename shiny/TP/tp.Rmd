...
author: |
  | B.Thieurmel, benoit.thieurmel@quadratic-labs.com
output:
  pdf_document:
...
* __Aller plus loin__ : Customiser un peu vos différents inputs avec  [shinyWidgets](https://dreamrs.github.io/shinyWidgets/) (https://dreamrs.github.io/shinyWidgets/)
...
* __Aller plus loin__ : utiliser [shinydashboard](https://rstudio.github.io/shinydashboard/) (https://rstudio.github.io/shinydashboard/) ou [bs4Dash](https://rinterface.github.io/bs4Dash/index.html) https://rinterface.github.io/bs4Dash/index.html) pour restructurer votre application.
...
* __Aller plus loin__ : Et pourquoi ne pas tester d'autres packages ? (http://gallery.htmlwidgets.org/) ou bien plotly avec ou sans ggplot2 ? (``plotly::ggplotly()``)
...
* __Aller plus loin__ : Ajouter une popup au lancement de l'application avec une message de bienvenue (``?modalDialog``)

* __Aller plus loin__ : Changer le thème de l’application avec [bslib](https://rstudio.github.io/bslib/) (https://rstudio.github.io/bslib/) 

* __Aller plus loin__ : Ajouter le choix entre les données ``faithfull`` et ``mtcars`` et gérer cela avec un ``reactiveVal`` ou un ``reactiveValues``

## Authentification et déploiement

* Ajouter une authentification simple basée sur une *data.frame* à votre application en utilisant [shinymanager](https://datastorm-open.github.io/shinymanager/) (https://datastorm-open.github.io/shinymanager/) 
...
* Déployer votre application sur *shinyapps.io*
    + https://www.shinyapps.io/
    + se créer un compte gratuit
    + suivre la documentation pour le déploiement (https://shiny.posit.co/r/articles/share/shinyapps/)
