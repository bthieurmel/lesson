...
- le code __R__ tourne au niveau du dossier de l'application, et peut donc accéder de façon relative à tous les objets présents dans le dossier de l'application
...
## Définir des élements de l'UI côté SERVER | Exemple
...
Plus récent avec [bs4dash](https://bs4dash.rinterface.com/) et d'autres fonctions pour créer des tableaux de bords :

![grid](img/bs4dash.png)
...
Plus généralement, jetez un oeil sur la [gallerie suivante!](http://gallery.htmlwidgets.org/) (http://gallery.htmlwidgets.org/)
...
- On définit alors de façon explicite l'espression qui représente l'événement _et_ l'expression qui sera éxécutée quand l'événement se produit, cette dernière étant automatiquement isolée.
...
- Modification de la valeur des objets avec des ``observe`` ou des ``observeEvent``, c'est-à-dire qu'on peut les modifier à plusieurs endroits / sous plusieurs conditions contrairement aux ``reactive` classiques !
...
- ``a(href="https://shiny.posit.co/", target="_blank", "Shiny")`` : lien vers un site
...
- [shinythemes](http://rstudio.github.io/shinythemes) (http://rstudio.github.io/shinythemes)
- [fresh](https://dreamrs.github.io/fresh/) (https://dreamrs.github.io/fresh/)
- [bslib](https://rstudio.github.io/bslib/) (https://rstudio.github.io/bslib/)
